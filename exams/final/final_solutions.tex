...
&=& \exponential{p\beta} = \text{Weibull}(1, \beta p) = \gammanot{1}{\beta p}\\
\eeqn
}
...
\Rightarrow~\expe{X_1 X_2} &=& \cov{X_1}{X_2} + \expe{X_1}\expe{X_2} \\
...
\beqn
	h_{t_1,t_2}(\t) &=& \pdv*{\bracks{\phi_{\X}(\t)}}{t_1,t_2}\\
	&=& \pdv*{\bracks{ e^{i (t_1 + 2t_2) -\half \parens{2t_1^2 - 2 t_2 t_1 + t_2^2}} }}{t_1,t_2}\\
	&=& \pdv*{\bracks{(2i + t_1 - t_2) \cdot \phi_{\X}(\t)}}{t_1}\\
